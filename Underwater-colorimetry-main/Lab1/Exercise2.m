...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Goal of this step: open a LINEAR image that includes a Macbeth color    %
% chart somewhere in the frame.                                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% You should have 3 .png images saved from Exercise 1 or provided         %
% by the instructors:                                                     %
%    - Your image with a color chart                                      %
%    - NikonImage.png (example camera)                                    %
%    - CanonImage.png (example camera)                                    %
%                                                                         %
% Replace 'ConvertedImage.png' with one of these filenames.               %
...
Brightness_factor = 2;
figure;imshow(I*Brightness_factor)
...
%      If you use a different chart, swap the dataset accordingly.        % 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
