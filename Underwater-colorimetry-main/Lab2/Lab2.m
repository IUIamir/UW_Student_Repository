...
% Cameras sensitivities of Nikon and Canon
nikon = importdata('data/Nikon_D90.csv');
canon = importdata('data/Canon_1Ds-Mk-II.csv');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Add the sensitivity of the third camera %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Uploading light data (illuminant-D65)
...
%%% Nikon %%%
%%%%%%%%%%%%%
% Select an achromatic patch to white balance.
% Let's pick the 23rd gray, with 9% reflectance but experiment with
% different patches!
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%                    plots                      %%%
% In these plots the Nikon and Canon are included,  %
%         you need to ADD THE THIRD CAMERA          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
plotChromaticity
hold on
plot(xy_image_nikon(:,1),xy_image_nikon(:,2),'go','linewidth',4, 'MarkerSize', 10)
plot(xy_image_canon(:,1),xy_image_canon(:,2),'bs','linewidth',2, 'MarkerSize', 10)
formatFigure
title('Canon and Nikon Chromaticity plot', 'FontSize', 20, 'FontWeight','bold')
...
legend({'', 'Nikon', 'Canon', 'White point'}, ...
       'FontSize', 15, 'Location', 'southeast', 'Box','on')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%   Don't forget to simulate the third camera!   %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
